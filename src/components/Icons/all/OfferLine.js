...
const OfferLine = (props) => {
  ...
  return (
    <Icon uniqueId={uniqueId} {...props}>
      <g>
        <path d="M7.5,9.1C8.4,9.1,9,8.4,9,7.6C9,6.7,8.4,6,7.5,6C6.7,6,6,6.7,6,7.6C6,8.4,6.7,9.1,7.5,9.1z"></path>
        <path d="M12.5,11.1c-0.8,0-1.5,0.7-1.5,1.5c0,0.8,0.7,1.5,1.5,1.5c0.8,0,1.5-0.7,1.5-1.5C14,11.7,13.4,11.1,12.5,11.1z"></path>
        <path
          d="M19.1,7.8l-0.7-0.7C18.1,6.8,18,6.5,18,6.2v-1C18,3.4,16.6,2,14.8,2h-0.9c-0.3,0-0.6-0.2-0.8-0.3L12.4,1
        ...
        ></path>
        <path
          d="M12.4,6.3l-6,6c-0.4,0.4-0.4,1,0,1.4c0.2,0.2,0.4,0.3,0.7,0.3c0.3,0,0.5-0.1,0.7-0.3l6-6c0.3-0.4,0.3-1.1,0-1.5
